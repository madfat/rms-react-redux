...
export const FIND_EMPLOYEE_BY_NAME = 'FIND_EMPLOYEE_BY_NAME';
export const SET_EMPLOYEES_PAGING = 'SET_EMPLOYEES_PAGING';
export const DELETE_GRADE_HISTORY_ITEM = 'DELETE_GRADE_HISTORY_ITEM';
export const FIND_EMPLOYEES_BY_FILTER = 'FIND_EMPLOYEES_BY_FILTER';
export const EMPLOYEES_FILTERED = 'EMPLOYEES_FILTERED';
